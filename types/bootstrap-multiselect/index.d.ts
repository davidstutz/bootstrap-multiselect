...
interface MultiSelectOptions {
     ...
     */
    onFiltering?: (filter: HTMLElement) => void;
    ...
    */
    ...
    /**
     * allSelectedText is the text displayed if all options are selected. You can disable displaying the allSelectedText by setting it to null.
     */
    ...
    /**
     * This option is used by the buttonText and buttonTitle functions to determine of too much options would be displayed. Default value is 3.
     */
    ...
    /**
     * Defines the number of options for which not yet the select all option is added. Default value is 0.
     */
