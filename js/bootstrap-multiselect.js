    ...
    Multiselect.prototype = {
        ...
        initOptions: function() {
          ...
          if(!this.options.multiple) {
            ...
            if(this.options.includeSelectAllOption!==true && this.options.includeSelectAllOption!==false) {
              this.options.includeSelectAll = (this.$select.children("option[data-role!=divider]").length > this.options.includeSelectAllIfMoreThan);
            }
          }
        },
        ...
        updateSelectAll: function() {
            if (this.hasSelectAll()) {
                ...
                if (selected.length === $('option:not([data-role=divider])', this.$select).length) {
